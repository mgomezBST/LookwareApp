...
//   //         minX: axisBounds.minX ?? 0.0, // Asegúrate de que el valor sea no nulo
//   //         minY: axisBounds.minY ?? 0.0, // Asegúrate de que el valor sea no nulo
//   //         maxX: axisBounds.maxX ?? 1.0, // Asegúrate de que el valor sea no nulo
//   //         maxY: axisBounds.maxY ?? 1.0, // Asegúrate de que el valor sea no nulo
...
//     return data.map((d) => double.tryParse(d)).toList();
//   } else if (data is List<DateTime>) {
//     return data.map((d) => d.millisecondsSinceEpoch.toDouble()).toList();
//   } else {
//     return [];
//   }
// }
